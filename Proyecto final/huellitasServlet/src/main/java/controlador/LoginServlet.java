...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (autenticarUsuario(username, password)) {
            ...
            response.sendRedirect("gestorMascotas.jsp"); // Redirigir a la página de gestion
        } else {
    ...
    private boolean autenticarUsuario(String username, String password) {
        ...
        try {
            ...
            String sql = "SELECT * FROM usuarios WHERE username = ? AND password = ?"; // Asegúrate de que esta consulta coincida con tu esquema de base de datos
